...
FAITHFULNESS_SYSTEM = (
    "당신은 RAG 답변 검증자입니다. 답변을 사실 주장 단위로 분해하고, 각 주장에 대해 "
    "① 제공된 근거 목록에 의해 지지되는지(supported), ② 답변에서 그 주장에 [n] 인용이 "
    "달려 있는지(cited)를 판정하세요. 근거에 없는 내용을 단정하면 unsupported입니다. "
    "인사말·기권 표현·근거 부족 고지는 주장이 아니므로 제외하세요. "
    'JSON만 출력: {"claims": [{"claim": "...", "supported": true|false, "cited": true|false, "reason": "..."}]}'
)
